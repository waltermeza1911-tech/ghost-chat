...
// 🚨 SUSTITUIR CON TU URL DE RAILWAY
  ...
  return (
    <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : "height"} style={{flex: 1}}>
      ...
      <View style={styles.inputArea}>
        <TouchableOpacity onPress={pickImage}><Text style={styles.icon}>📷</Text></TouchableOpacity>
        <TextInput style={styles.chatInput} value={mensaje} onChangeText={setMensaje} />
        <TouchableOpacity onPress={() => enviar(mensaje)}><Text style={styles.icon}>🚀</Text></TouchableOpacity>
      </View>
